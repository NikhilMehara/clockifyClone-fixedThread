  ...
  return (
    ...
    >
      ...
      >
          ...
          <Center>
         <SimpleGrid width={"80%"}  columns={[1,2,3]} spacing="30px" paddingBottom={"30px"}>
          <Box>
      ...
      <Container maxW={"-moz-fit-content"} py={16} as={Stack} spacing={12} >
        ...
        <Grid templateColumns={['repeat(2, 1fr)','repeat(3, 1fr)','repeat(4, 1fr)']} paddingLeft={[3,6,10]} gap={[20,12,6]}>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Timer</Heading>
               <Text>Track time using a stopwatch.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Add Time</Heading>
               <Text>Enter and edit hours manually.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Continue</Heading>
               <Text>Continue tracking with one click.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Billable</Heading>
        ...
        <Grid templateColumns={['repeat(2, 1fr)','repeat(3, 1fr)','repeat(4, 1fr)']} paddingLeft={[3,6,10]} gap={[20,12,6]}>
               ...
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Templates</Heading>
               <Text>Quickly load activities each week.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Approval</Heading>
               <Text>Submit and approve timesheets.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Reminders</Heading>
        ...
        <Grid templateColumns={['repeat(2, 1fr)','repeat(3, 1fr)','repeat(4, 1fr)']} paddingLeft={[3,6,10]} gap={[20,12,6]}>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Clock-in</Heading>
               <Text>Punch in from a shared device.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Breaks</Heading>
               <Text>Track employee breaks.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>PIN</Heading>
               <Text>Sign in with personal code.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Activity</Heading>
        ...
        <Grid templateColumns={['repeat(2, 1fr)','repeat(3, 1fr)','repeat(4, 1fr)']} paddingLeft={[3,6,10]} gap={[20,12,6]}>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Visualize</Heading>
               <Text>See how your day looks like.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Add</Heading>
               <Text>Block hours with a click.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Edit</Heading>
               <Text>Edit blocks by resizing.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Connect</Heading>
      ...
      <Element name="reports">
        ...
        <Stack align={"center"}>
           <Image src={"https://clockify.me/assets/images/features/features-reports-screenshot.svg"} width={"90%"} />
        </Stack>
        <Grid templateColumns={['repeat(2, 1fr)','repeat(3, 1fr)','repeat(4, 1fr)']} paddingLeft={[3,6,10]} gap={[20,12,6]}>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Breakdowns</Heading>
               ...
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Filters</Heading>
               <Text>Drill down into your data.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Share</Heading>
               <Text>Share reports with clients via link.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Exports</Heading>
        ...
        <Stack align={"center"}>
           <Image src={"https://clockify.me/assets/images/features/features-locations-screenshot.png"} width={"90%"} />
        </Stack>
        <Grid templateColumns={['repeat(2, 1fr)','repeat(3, 1fr)','repeat(4, 1fr)']} paddingLeft={[3,6,10]} gap={[20,12,6]}>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Locations</Heading>
               <Text>Track GPS location.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Routes</Heading>
               <Text>See all visited locations.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Screenshots</Heading>
               <Text>Record what you've worked on.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Privacy</Heading>
        ...
        <Stack align={"center"}>
           <Image src={"https://clockify.me/assets/images/features/features-projects-screenshot.svg"} width={"90%"} />
        </Stack>
        <Grid templateColumns={['repeat(2, 1fr)','repeat(3, 1fr)','repeat(4, 1fr)']} paddingLeft={[3,6,10]} gap={[20,12,6]}>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Tasks</Heading>
               <Text>Categorize by job type.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Rates</Heading>
               <Text>Multiple levels of hourly rates.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Budgets</Heading>
               <Text>Set budget or time estimate.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Alerts</Heading>
      ...
      <Element name="team">
        ...
        <Stack align={"center"}>
           <Image src={"https://clockify.me/assets/images/features/features-team-screenshot.svg"} width={"90%"} />
        </Stack>
        <Grid templateColumns={['repeat(2, 1fr)','repeat(3, 1fr)','repeat(4, 1fr)']} paddingLeft={[3,6,10]} gap={[20,12,6]}>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Invite Team</Heading>
               ...
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Managers</Heading>
               <Text>Give additional permissions.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Groups</Heading>
        ...
        <Stack align={"center"}>
           <Image src={"https://clockify.me/assets/images/features/features-scheduling-projects-screenshot.svg"} width={"90%"} />
        </Stack>
        <Grid templateColumns={['repeat(2, 1fr)','repeat(3, 1fr)','repeat(4, 1fr)']} paddingLeft={[3,6,10]} gap={[20,12,6]}>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Milestones</Heading>
               <Text>Visualize projects on timeline.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Assignments</Heading>
               <Text>Decide who works on what.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Capcity</Heading>
               <Text>See who can take on more work.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Publish</Heading>
        ...
        <Stack align={"center"}>
           <Image src={"https://clockify.me/assets/images/features/features-timeoff-screenshot.svg"} width={"90%"} />
        </Stack>
        <Grid templateColumns={['repeat(2, 1fr)','repeat(3, 1fr)','repeat(4, 1fr)']} paddingLeft={[3,6,10]} gap={[20,12,6]}>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Policies</Heading>
               <Text>Create time off policies</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Holidays</Heading>
               <Text>Define holidays for paid leaves</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Requests</Heading>
               <Text>Request and approve leaves.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Balance</Heading>
        ...
        <Stack spacing={0} align={'center'}>
          ...
          <Text>Officially approve your team's timesheets and expenses.</Text>
        </Stack>
        <Stack align={"center"}>
           <Image src={"https://clockify.me/assets/images/features/features-approval-screenshot.svg"} width={"90%"} />
        </Stack>
        <Grid templateColumns={['repeat(2, 1fr)','repeat(3, 1fr)','repeat(4, 1fr)']} paddingLeft={[3,6,10]} gap={[20,12,6]}>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Submit</Heading>
               ...
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Immutablity</Heading>
               <Text>Prevent further changes.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>History</Heading>
        ...
        <Stack align={"center"}>
           <Image src={"https://clockify.me/assets/images/features/features-expenses-screenshot.svg"} width={"90%"} />
        </Stack>
        <Grid templateColumns={['repeat(2, 1fr)','repeat(3, 1fr)','repeat(4, 1fr)']} paddingLeft={[3,6,10]} gap={[20,12,6]}>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Track</Heading>
               <Text>Record by sum or unit.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Types</Heading>
               <Text>Define expense types.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Receipts</Heading>
               <Text>Attach expense receipts.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Report</Heading>
        ...
        <Stack spacing={0} align={'center'}>
          ...
          <Text>Issue invoices based on tracked time, expenses, and hourly rates.</Text>
        </Stack>
        <Stack align={"center"}>
           <Image src={"https://clockify.me/assets/images/features/features-invoicing-screenshot.svg"} width={"90%"} />
        </Stack>
        <Grid templateColumns={['repeat(2, 1fr)','repeat(3, 1fr)','repeat(4, 1fr)']} paddingLeft={[3,6,10]} gap={[20,12,6]}>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Create</Heading>
               <Text>Import time and edit invoices.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>PDF</Heading>
               <Text>Download and send to client.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Costumize</Heading>
               <Text>Add company logo and notes.</Text>
               </GridItem>
               <GridItem w='100%' h='10'>
               <Heading size="md" fontWeight={"medium"}>Expenses</Heading>
