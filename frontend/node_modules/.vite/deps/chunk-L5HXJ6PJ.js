...
function useEventListener(event, handler, env, options) {
  ...
  (0, import_react2.useEffect)(() => {
    var _a;
    const node2 = (_a = runIfFn(env)) != null ? _a : document;
    if (!handler) {
      return;
    }
...
function useAnimationState(props) {
  ...
  const [once2, setOnce] = (0, import_react.useState)(false);
...
function useControllableState(props) {
  ...
  const updateValue = (0, import_react8.useCallback)((next2) => {
    const nextValue = runIfFn(next2, value);
...
function useId(idProp, prefix3) {
  ...
  return (0, import_react10.useMemo)(() => idProp || [prefix3, id].filter(Boolean).join("-"), [idProp, prefix3, id]);
}
...
function useOptionalPart(partId) {
  ...
  const ref = (0, import_react10.useCallback)((node2) => {
...
function useEventListenerMap() {
  ...
  const add2 = (0, import_react12.useCallback)((el, type, listener, options) => {
...
function useUnmountEffect(fn, deps = []) {
  return (0, import_react16.useEffect)(() => () => fn(), deps);
}
function useForceUpdate() {
  const unloadingRef = (0, import_react15.useRef)(false);
...
function useShortcut(props = {}) {
  ...
  const [keys2, setKeys] = (0, import_react24.useState)([]);
...
function useColorMode() {
  const context = (0, import_react29.useContext)(ColorModeContext);
  if (context === void 0) {
...
function ColorModeProvider(props) {
  ...
  const [colorMode, rawSetColorMode] = (0, import_react28.useState)(() => getTheme(colorModeManager, defaultColorMode));
  const [resolvedColorMode, setResolvedColorMode] = (0, import_react28.useState)(() => getTheme(colorModeManager));
  const { getSystemTheme, setClassName, setDataset, addListener } = (0, import_react28.useMemo)(() => getColorModeUtils({ preventTransition: disableTransitionOnChange }), [disableTransitionOnChange]);
  const resolvedValue = initialColorMode === "system" && !colorMode ? resolvedColorMode : colorMode;
  const setColorMode = (0, import_react28.useCallback)((value2) => {
  ...
  const toggleColorMode = (0, import_react28.useCallback)(() => {
  ...
  return import_react27.default.createElement(ColorModeContext.Provider, {
    value: context
  }, children);
}
if (__DEV__) {
...
function getScriptSrc(props = {}) {
  ...
  const init = normalize2(initialColorMode);
...
function ColorModeScript(props = {}) {
  return import_react27.default.createElement("script", {
    id: "chakra-script",
...
var systemProps = (0, import_lodash.default)({}, background, border, color, flexbox, layout, filter, ring, interactivity, grid, others, position, effect, space, scroll, typography, textDecoration, transform, list, transition);
    ...
    for (let key in styles) {
      ...
      if (Array.isArray(value) || isObject(value) && isResponsive(value)) {
        ...
        for (let index = 0; index < values.length; index++) {
          ...
          if (media) {
            if (val == null) {
              (_a2 = computedStyles[media]) != null ? _a2 : computedStyles[media] = {};
            } else {
              computedStyles[media] = Object.assign({}, computedStyles[media], css22({ [key]: val }, true));
            }
          } else {
            computedStyles = Object.assign({}, computedStyles, css22({ ...styles, [key]: val }, false));
          }
        }
        continue;
      }
      ...
      if (isObject(value)) {
        computedStyles[key] = Object.assign({}, computedStyles[key], css22(value, true));
        continue;
      }
      ...
      let rawValue = (_b = (_a = config == null ? void 0 : config.transform) == null ? void 0 : _a.call(config, value, theme, styles)) != null ? _b : value;
...
function createResolver(theme) {
  ...
  return function resolver(config, prop, value, props) {
    ...
    if (!breakpointUtil)
      return;
    const result = {};
    const normalized = normalize3(value, breakpointUtil.toArrayValue);
    if (!normalized)
      return result;
...
function resolveStyleConfig(config) {
  return (props) => {
    ...
    return (0, import_lodash.default)({}, runIfFn((_a = config.baseStyle) != null ? _a : {}, props), recipe(config, "sizes", size, props), recipe(config, "variants", variant, props));
  };
}
...
var EmotionCacheContext = (0, import_react30.createContext)(
...
var withEmotionCache = function withEmotionCache2(func) {
  return (0, import_react30.forwardRef)(function(props, ref) {
    var cache = (0, import_react30.useContext)(EmotionCacheContext);
...
var ThemeProvider = function ThemeProvider2(props) {
  var theme = (0, import_react30.useContext)(ThemeContext);
  if (props.theme !== theme) {
    theme = createCacheWithTheme(theme)(props.theme);
  }
  return (0, import_react30.createElement)(ThemeContext.Provider, {
    value: theme
  }, props.children);
};
...
var Emotion = withEmotionCache(function(props, cache, ref) {
  ...
  var serialized = serializeStyles(registeredStyles, void 0, (0, import_react30.useContext)(ThemeContext));
  ...
  return (0, import_react30.createElement)(import_react30.Fragment, null, (0, import_react30.createElement)(Insertion, {
    cache,
    serialized,
    isStringTag: typeof WrappedComponent === "string"
  }), (0, import_react30.createElement)(WrappedComponent, newProps));
});
if (true) {
...
var useInsertionEffect5 = React3["useInsertionEffect"] ? React3["useInsertionEffect"] : import_react31.useLayoutEffect;
...
var Global = withEmotionCache(function(props, cache) {
  ...
  var serialized = serializeStyles([styles], void 0, (0, import_react31.useContext)(ThemeContext));
  var sheetRef = (0, import_react31.useRef)();
...
var ClassNames = withEmotionCache(function(props, cache) {
  ...
  var content = {
    css: css3,
    cx: cx2,
    theme: (0, import_react31.useContext)(ThemeContext)
  };
  var ele = props.children(content);
  hasRendered = true;
  return (0, import_react31.createElement)(import_react31.Fragment, null, (0, import_react31.createElement)(Insertion3, {
    cache,
    serializedArr
  }), ele);
});
...
function mergeRefs(...refs) {
  return (node2) => {
    refs.forEach((ref) => assignRef2(ref, node2));
  };
}
function createContext3(options = {}) {
  ...
  const Context = (0, import_react32.createContext)(void 0);
...
function getValidChildren(children) {
  return import_react33.Children.toArray(children).filter((child) => (0, import_react33.isValidElement)(child));
}
  ...
  return function() {
    ...
    var Styled = withEmotionCache(function(props, cache, ref) {
      ...
      if (props.theme == null) {
        ...
        mergedProps.theme = (0, import_react34.useContext)(ThemeContext);
      }
      if (typeof props.className === "string") {
      ...
      newProps.className = className;
      newProps.ref = ref;
      return (0, import_react34.createElement)(import_react34.Fragment, null, (0, import_react34.createElement)(Insertion5, {
        cache,
        serialized,
        isStringTag: typeof FinalTag === "string"
      }), (0, import_react34.createElement)(FinalTag, newProps));
    });
...
function ThemeProvider3(props) {
  ...
  const computedTheme = (0, import_react43.useMemo)(() => toCSSVar(theme), [theme]);
  return import_react38.default.createElement(ThemeProvider, {
    theme: computedTheme
  }, import_react38.default.createElement(CSSVars, {
    root: cssVarsRoot
  }), children);
}
function CSSVars({ root = ":host, :root" }) {
  const selector = [root, `[data-theme]`].join(",");
  return import_react38.default.createElement(Global, {
...
function forwardRef2(component) {
  return (0, import_react44.forwardRef)(component);
}
function useStyleConfigImpl(themeKey, props = {}) {
  ...
  const mergedProps = (0, import_lodash.default)({ theme, colorMode }, (_a = styleConfig == null ? void 0 : styleConfig.defaultProps) != null ? _a : {}, filterUndefined(omit(rest, ["children"])));
  const stylesRef = (0, import_react45.useRef)({});
  if (styleConfig) {
...
var fallbackIcon = {
  path: import_react46.default.createElement("g", {
    stroke: "currentColor",
    strokeWidth: "1.5"
  ...
  }), import_react46.default.createElement("circle", {
    fill: "none",
    strokeMiterlimit: "10",
    cx: "12",
    cy: "12",
...
var Icon = forwardRef2((props, ref) => {
  ...
  if (element && typeof element !== "string") {
    return import_react46.default.createElement(chakra.svg, {
      as: element,
      ...shared,
      ...rest
    });
...
function createIcon(options) {
  ...
  const path = import_react47.Children.toArray(options.path);
  const Comp = forwardRef2((props, ref) => import_react46.default.createElement(Icon, {
    ref,
    viewBox,
    ...defaultProps,
    ...props
  }, path.length ? path : import_react46.default.createElement("path", {
    fill: "currentColor",
    d: pathDefinition
  })));
  if (__DEV__) {
...
//# sourceMappingURL=chunk-L5HXJ6PJ.js.map
